...
$('#input-form').submit(function(e){
    ...
    var dataInTable = "<td style='border:1px solid black;vertical-align: top;white-space: pre-wrap; width:25%;padding: 0 0 10px 5px;'><span id='"+base_elem_id+"-issue-final1'>"+$('#issue').val()+"</span></td>"+
                      "<td style='border:1px solid black;vertical-align: top;white-space: pre-wrap; width:25%;padding: 0 0 10px 5px;'><span id='"+base_elem_id+"-risk-final1'>"+$('#risk').val()+"</span></td>"+
                      "<td style='border:1px solid black;vertical-align: top;white-space: pre-wrap; width:25%;padding: 0 0 10px 5px;'><span id='"+base_elem_id+"-action-final1'>"+$('#action').val()+"</span></td>"+
    ...
    tableHeader = "<tr id='"+base_elem_id+"-row-disp-1' style='border-bottom:1px solid black;' class='"+base_elem_id+"-report-data-row editor-row'>"+
                  ...
                  "<td style='border-bottom:1px solid black; border-top:1px solid black;padding: 0 0 10px 5px;' colspan='5' ><span style='font-style: italic;font-weight: bold;' id='"+base_elem_id+"-heading-display1'>"+$('#heading').val()+" </span><input type='text' id='"+base_elem_id+"-heading' class='editor-input hidden' value='"+$('#heading').val()+"'/> </td></tr>";
    dataInTable = "<td style='border-right:1px solid black; border-bottom:1px solid black;vertical-align: top;white-space: pre-wrap; width:25%;padding: 0 0 10px 5px;'><span id='"+base_elem_id+"-issue-display1'>"+$('#issue').val()+"</span><textarea id='"+base_elem_id+"-issue' type='text' class='editor-input hidden' >"+$('#issue').val()+"</textarea></td>"+
                  "<td style='border-right:1px solid black; border-bottom:1px solid black;vertical-align: top;white-space: pre-wrap; width:25%;padding: 0 0 10px 5px;'><span id='"+base_elem_id+"-risk-display1'>"+$('#risk').val()+"</span><textarea id='"+base_elem_id+"-risk' type='text' class='editor-input hidden'>"+$('#risk').val()+"</textarea></td>"+
                  "<td style='border-right:1px solid black; border-bottom:1px solid black;vertical-align: top;white-space: pre-wrap; width:25%;padding: 0 0 10px 5px;'><span id='"+base_elem_id+"-action-display1'>"+$('#action').val()+"</span><textarea id='"+base_elem_id+"-action' type='text' class='editor-input hidden'>"+$('#action').val()+"</textarea></td>"+
...
function addAnotherDataRow(rowId){
    ...
    var dataInTable = "<td style='border:1px solid black;vertical-align: top;white-space: pre-wrap;padding: 0 0 10px 5px;width:25%;'><span id='"+id+"-issue-final"+incrementedRowValue+"'></span></td>"+
                "<td style='border:1px solid black;vertical-align: top;white-space: pre-wrap;padding: 0 0 10px 5px;width:25%;'><span id='"+id+"-risk-final"+incrementedRowValue+"'></span></td>"+
                "<td style='border:1px solid black;vertical-align: top;white-space: pre-wrap;padding: 0 0 10px 5px;width:25%;'><span id='"+id+"-action-final"+incrementedRowValue+"'></span></td>"+
                "<td style='border:1px solid black;vertical-align: top;padding-top:10px;padding-bottom:10px;padding: 0 0 10px 5px;width:10%;'><div id='"+id+"-cpcs-final"+incrementedRowValue+"'></div></td>"+
                "<td style='border:1px solid black; text-align:center;vertical-align: top;padding: 0 0 10px 5px;width:10%;'><div id='"+id+"-significance-final"+incrementedRowValue+"'></div></td>"
    ...
    dataInTable = "<td style='border-right:1px solid black; border-bottom:1px solid black;vertical-align: top;white-space: pre-wrap;padding: 0 0 10px 5px;width:25%;'><span id='"+id+"-issue-display"+incrementedRowValue+"'></span><textarea style='width:100%;' rows=5 placeholder='Issue' id='"+id+"-issue-disp"+incrementedRowValue+"' type='text' class='editor-input'></textarea></td>"+
                  "<td style='border-right:1px solid black; border-bottom:1px solid black;vertical-align: top;white-space: pre-wrap;padding: 0 0 10px 5px;width:25%;'><span id='"+id+"-risk-display"+incrementedRowValue+"'></span><textarea style='width:100%;' rows=5 placeholder='Risk' id='"+id+"-risk-disp"+incrementedRowValue+"' type='text' class='editor-input'></textarea></td>"+
                  "<td style='border-right:1px solid black; border-bottom:1px solid black;vertical-align: top;white-space: pre-wrap;padding: 0 0 10px 5px;width:25%;'><span id='"+id+"-action-display"+incrementedRowValue+"'></span><textarea style='width:100%;' rows=5 placeholder='Action' id='"+id+"-action-disp"+incrementedRowValue+"' type='text' class='editor-input'></textarea></td>"+
                  "<td style='border-right:1px solid black; border-bottom:1px solid black;vertical-align: top;padding: 0 0 10px 5px;width:10%;'><div id='"+id+"-cpcs-display"+incrementedRowValue+"'></div><div class='' id='"+id+"-cpcs-disp"+incrementedRowValue+"'>"+cpCsCheckBoxes+"</div></td>"+
                  "<td style='text-align:center; border-bottom:1px solid black;padding: 0 0 10px 5px;width:10%;'><div id='"+id+"-significance-display"+incrementedRowValue+"'></div><div class='' id='"+id+"-significance-disp"+incrementedRowValue+"'>"+significanceRadio+"</div></td>"
